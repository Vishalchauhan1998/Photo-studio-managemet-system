<?php include "header.php"; ?>
  <!--//================breadcrumb start==============//-->
        <section class="breadcamb-area">
            <div class="main_breadcamb positionR">
                <figure class="slider-image positionR">
                    <img src="assets/img/bradcamb/banner4.png" alt=""/>
                </figure>
        ...
        <!--//================contact start=============//-->	
        <section id="contact_layout" class="pad-top100">
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="address_contact">
                            <h4 class="mar-bottom20">Detail</h4>
                            <ul>
                                <li class="mar-bottom20"><i class="fa fa-map-marker" aria-hidden="true"></i><span> M.G Road, Bardoli - 394601</span></li>
                                <li class="mar-bottom20"><i class="fa fa-phone" aria-hidden="true"></i><span>+91 7096 544 247</span></li>
                                <!--<li class="mar-bottom20"><i class="fa fa-envelope" aria-hidden="true"></i><span></span></li>-->
                            </ul>
                        </div>
                    </div>
