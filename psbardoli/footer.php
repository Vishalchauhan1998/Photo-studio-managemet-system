<!-- FOOTER -->
    <footer class="footer text-center clearfix">Developed By Vishal Chauhan, Harsh Patel And Harsh Patel</footer>
    </div>
    <!--/ #wrapper -->
    <!-- Scripts -->
    ...
    <script src="cdnjs.cloudflare.com/ajax/libs/clndr/1.4.7/clndr.min.js"></script>
