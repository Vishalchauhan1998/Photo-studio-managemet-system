...
<main class="main-wrapper clearfix">
	<div class="row page-title clearfix">
			<div class="page-title-left">
				<h5 class="mr-0 mr-r-5">Anniversary Report</h5>
			</div>
                <!-- /.page-title-left -->
			<div class="page-title-right d-inline-flex">
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active">Anniversary Report</li>
				</ol>
			</div>
  </div>
     <!-- /.page-title-right -->
			...
			<div class="widget-body clearfix">
				...
				<table style="width:100%;" border="0">
					...
					<td colspan="4">
						...
						<h4 class="text-center text-info"> Customer Annivarsary Report </h4>
				...
				<table class="table">
					...
					<tbody>
						<?php
							$query1 = mysql_query("SELECT * FROM `order_mst` WHERE `FUNCTION_DATE` LIKE '%".'-'.$_GET['db'].'-'."%'");
							while($que1 = mysql_fetch_array($query1))
							{
								$cust = mysql_query("SELECT * FROM customer_details WHERE CUSTOMER_ID = '".$que1['CUSTOMER_ID']."'");
								$que2 = mysql_fetch_array($cust);				
						?>
						<tr>
							<td><?php echo $que2['CUSTOMER_NAME']?></td>
							<td><?php echo $que2['CUSTOMER_CONTACT']?></td>
							<td><?php echo $que2['CUSTOMER_ADDRESS']?></td>
							<td><?php echo $que2['CUSTOMER_EMAIL']?></td>
