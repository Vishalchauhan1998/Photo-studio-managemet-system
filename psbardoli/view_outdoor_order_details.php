...
<div class="row page-title clearfix">
	<div class="page-title-left">
		<h5 class="mr-0 mr-r-5">Display Outdoor Order Details</h5>
	</div>
		<!-- /.page-title-left -->
	<div class="page-title-right d-inline-flex">
		<ol class="breadcrumb">
			<li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
			<li class="breadcrumb-item active">View Outdoor Order</li>
		</ol>
	</div>
</div>
<!-- /.page-title-right -->
		...
		<div class="widget-bg">
			<div class="widget-heading clearfix">
				<h3 class="box-title mr-b-0">
					List of Outdoor Order....
					<font style="float:right"> <a href="insert_order_details.php">Add Outdoor Order Details</a> </font>
				</h3>
			</div>
			<!-- /.widget-heading -->
			<div class="widget-body clearfix">
				<table class="table table-striped table-responsive" data-toggle="datatables">
					...
					<tbody>
						<?php
							$counter = 0;
							$query = mysql_query("select * from order_mst WHERE ORDER_TYPE = 'O'");
